...
def plot_generic(dfr, name_field, names=None, fields=None,
                 prettify_name=None, width=None, height=None, xlim="default",
                 ylim="range", drawstyle="default", ax=None, title=""):
    """
    ...
    if names is None:
        ...
        names = dfr[name_field].unique().tolist()
    else:
